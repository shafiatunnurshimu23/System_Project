...
} elseif ($_instance->childHasBeenRendered('BHofo8F')) {
    $componentId = $_instance->getRenderedChildComponentId('BHofo8F');
    $componentTag = $_instance->getRenderedChildComponentTagName('BHofo8F');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BHofo8F');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('BHofo8F', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('rHBfyge')) {
    $componentId = $_instance->getRenderedChildComponentId('rHBfyge');
    $componentTag = $_instance->getRenderedChildComponentTagName('rHBfyge');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rHBfyge');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('rHBfyge', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('JQAxQlP')) {
    $componentId = $_instance->getRenderedChildComponentId('JQAxQlP');
    $componentTag = $_instance->getRenderedChildComponentTagName('JQAxQlP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JQAxQlP');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('JQAxQlP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ILMmXPD')) {
    $componentId = $_instance->getRenderedChildComponentId('ILMmXPD');
    $componentTag = $_instance->getRenderedChildComponentTagName('ILMmXPD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ILMmXPD');
} else {
    $response = \Livewire\Livewire::mount('nav-all-categories-component');
    $html = $response->html();
    $_instance->logRenderedChild('ILMmXPD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
						</li>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/layouts/base.blade.php ENDPATH**/ ?>