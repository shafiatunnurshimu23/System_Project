              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">$<?php echo e($totalRevenue); ?></span>
                  </div>   
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value"><?php echo e($totalSales); ?></span>
                  </div>    
                  <div class="col-xs-4 text-center">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">$<?php echo e($todayRevenue); ?></span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-dollar icon-stat-visual bg-primary"></i>
                  </div>
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value"><?php echo e($todaySales); ?></span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                  </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/admin/admin-dashboard-component.blade.php ENDPATH**/ ?>