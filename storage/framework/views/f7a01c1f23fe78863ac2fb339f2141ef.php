                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?php echo e(route('user.orders')); ?>" class="btn btn-primary pull-right">My Orders</a>
                                ...
                                <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="pr-cart-item">
                                        ...
                                        <?php if($order->status == 'delivered' && $item->rstatus == false): ?>
                                            <div class="price-field sub-total"><p class="price"><a href="<?php echo e(route('user.review', ['order_item_id' => $item->id])); ?>">Write a Review</a></p></div>
                                        <?php endif; ?>
                                    </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/user/user-order-details-component.blade.php ENDPATH**/ ?>