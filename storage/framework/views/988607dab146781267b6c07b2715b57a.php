                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?php echo e(route('admin.product')); ?>" class="btn btn-primary pull-right">All Products</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="name" wire:keyup="generateSlug">
                                        <option value="">Select Product</option>
                                        <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($purchase->name); ?>"><?php echo e($purchase->name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Product ID" class="form-control input-md" wire:model="slug"/>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/admin/admin-add-product-component.blade.php ENDPATH**/ ?>