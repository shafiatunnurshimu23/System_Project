                        ...
                        <ol class="commentlist">
                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                <div id="comment-20" class="comment_container"> 
                                    <img alt="" src="<?php echo e(asset('asset/product_image')); ?>/<?php echo e($orderItem->product->image); ?>" height="80" width="80">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/user/user-review-component.blade.php ENDPATH**/ ?>