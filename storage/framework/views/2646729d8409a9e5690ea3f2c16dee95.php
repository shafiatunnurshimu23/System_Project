<div>
    ...
    <style>
        ...
        #page-header {
            background-image: url(<?php echo e(asset('asset/blog.png')); ?>);
            width: 100%;
            height: 30vh;
    ...
    <section id="blogs">            
        <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="blog-box">
                <div class="blog-img">
                    <img src="<?php echo e(asset('asset/blogs')); ?>/<?php echo e($blog->image); ?>" alt="">
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/blog-component.blade.php ENDPATH**/ ?>