	...
	<div class="container">
		...
		<div class="wrap-breadcrumb">
			<ul>
				...
				<li class="item-link"><a href="/shop"><span>Products</span></a></li>
						...
						<div class="widget-content">
							<ul class="list-category">
								...
								<?php if($category_name==$category->name): ?>
									<li class="category-item <?php echo e(count($category->subCategories) > 0 ? 'has-child-cate':''); ?>" style="background: rgb(215, 215, 218); padding: 0 4px; 0 4px; border-radius: 5px; width: 100%;">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eShop/resources/views/livewire/category-component.blade.php ENDPATH**/ ?>