			...
			<div class="row">
				...
				<div class="mainbar header-sticky">
					<ul class="navbarr">
						...
						@endif
						@if(Request::url()=='http://eshoppingbd.xyz/product-category/womens-fashion')
						...
						@endif
						@if(Request::url()=='http://eshoppingbd.xyz/product-category/electronics')
						...
						@endif
						@if(Request::url()=='http://eshoppingbd.xyz/product-category/mobile-laptop')
