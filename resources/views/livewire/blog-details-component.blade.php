<div>
    <style>
        ...
        <h2 style="font-weight: bold; padding: 50px 100px 20px 100px; text-align:center;">{{$blogs->title}}</h2>
        <img src="{{asset('asset/blogs')}}/{{$blogs->image}}" alt="" style="display: block; margin: 0 auto; ">
